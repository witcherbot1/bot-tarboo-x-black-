...
global.dfail = (type, m, conn) => {
  ...
  const aa={'quoted':m,'userJid':conn['user']['jid']},prep=generateWAMessageFromContent(m['chat'],{'extendedTextMessage':{'text':msg,'contextInfo':{'externalAdReply':{'title':'[ ⚠️ ] عذراً','body':'بوت التربو','thumbnail':imagen1,'sourceUrl':'https://whatsapp.com/channel/0029VaL2bnW0rGiPZq8B5S2M'}}}},aa);if(msg)return conn['relayMessage'](m['chat'],prep['message'],{'messageId':prep['key']['id']});
};
